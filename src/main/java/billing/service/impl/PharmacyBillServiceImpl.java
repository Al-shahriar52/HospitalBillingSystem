...
public class PharmacyBillServiceImpl implements PharmacyBillService {
    ...
    public PharmacyBillResponse getAllByOrgAndUserId(int pageNo,
        ...
        Pageable pageable = PageRequest.of(pageNo, pageSize, Sort.by(sortBy));
        Page<PharmacyBill> pharmacyBills = pharmacyBillRepository
                .findAllByOrganizationIdAndCreatedById(pageable,orgId,userId);
    ...
    @Override
    public PharmacyBillResponse search(int pageNo, int pageSize, String sortBy, Long orgId, String query) {

        Pageable pageable = PageRequest.of(pageNo, pageSize, Sort.by(sortBy));
        Page<PharmacyBill> pharmacyBills = pharmacyBillRepository.search(pageable,orgId,query);
