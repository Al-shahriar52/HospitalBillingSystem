...
public class DrAppointmentServiceImpl implements DrAppointmentService {
    ...
    public DrAppointmentBillDto add(Long appUserId,
        ...
        bill.getCreatedBy().setPassword(null);
    ...
    @Override
    public AppointmentResponse getAll(int pageNo,
                                      int pageSize,
                                      String sortBy) {
    ...
    public AppointmentResponse getAllByOrgAndUserId(int pageNo,
        ...
        Pageable pageable = PageRequest.of(pageNo,pageSize,Sort.by(sortBy));
        Page<DrAppointmentBill> appointmentBills = drAppointmentRepository
                .findAllDrAppointmentBillByOrganizationIdAndCreatedById(pageable,orgId,userId);
    ...
    public AppointmentResponse getAllByOrgAndOrgDr(int pageNo,
        ...
        Pageable pageable = PageRequest.of(pageNo,pageSize,Sort.by(sortBy));
        Page<DrAppointmentBill> appointmentBills = drAppointmentRepository
                .findAllByOrganizationIdAndOrgDoctorId(pageable,orgId,orgDoctorId);
    ...
    @Override
    public AppointmentResponse search(int pageNo,int pageSize, String sortBy, Long orgID, String query) {

        Pageable pageable = PageRequest.of(pageNo, pageSize, Sort.by(sortBy));
        Page<DrAppointmentBill> appointmentBills = drAppointmentRepository.search(pageable, orgID,query);
