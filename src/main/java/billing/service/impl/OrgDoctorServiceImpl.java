...
public class OrgDoctorServiceImpl implements OrgDoctorService {
    ...
    public OrgDoctorServiceImpl(OrgDoctorRepository orgDoctorRepository,
    ...
    public OrgDoctorDto add(Long appUserId,
        ...
        newOrgDoctor.getAppUser().setPassword(null);
    ...
    public OrgDoctorResponse getAll(int pageNo, int pageSize, String sortBy) {
        ...
        List<OrgDoctorDto> content = listOfOrgDoctors.stream().map(orgDoctor ->
                mapToDto(orgDoctor)).collect(Collectors.toList());
    ...
    public OrgDoctorResponse getAllByAppUserOrgId(int pageNo,
        ...
        Pageable pageable = PageRequest.of(pageNo, pageSize, Sort.by(sortBy));
        Page<OrgDoctor> orgDoctors = orgDoctorRepository
                .findAllOrgDoctorByOrganizationIdAndAppUserId(pageable, appUserId, orgId);
    ...
    public OrgDoctorDto updateById(OrgDoctorDto orgDoctorDto, Long id) {
        ...
        OrgDoctor orgDoctor = orgDoctorRepository.findById(id).orElseThrow(()->
                new ResourceNotFound("OrgDoctor","id",id));
        ...
        orgDoctor.setAvailableDayTimes(orgDoctorDto.getAvailableDayTimes());
    ...
    public OrgDoctorResponse searchOrgDoctor(int pageNo,
        ...
        Pageable pageable = PageRequest.of(pageNo, pageSize , Sort.by(sortBy));
        Page<OrgDoctor> orgDoctors = orgDoctorRepository.searchOrgDoctor(pageable, orgId,query);
