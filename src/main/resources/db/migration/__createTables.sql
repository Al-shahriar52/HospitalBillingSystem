...
CREATE TABLE `org_doctor` (
                              ...
                              KEY `FK_orgDoctor_organization` (`organization_id`),
                              CONSTRAINT `FK_orgDoctor_doctor` FOREIGN KEY (`doctor_id`) REFERENCES `doctor` (`id`),
                              CONSTRAINT `FK_orgDoctor_organization` FOREIGN KEY (`organization_id`) REFERENCES `organization` (`id`),
...
CREATE TABLE `org_doctor_available_day_times` (
                                                  ...
                                                  UNIQUE KEY `UK_avaiableTimes` (`available_day_times_id`),
                                                  KEY `FK_availableTimes_orgDoctor` (`org_doctor_id`),
                                                  CONSTRAINT `FK6pws5ase5altcw5rni5npmiww` FOREIGN KEY (`available_day_times_id`) REFERENCES `dr_available_times` (`id`),
                                                  CONSTRAINT `FK_availableTimes_orgDoctor` FOREIGN KEY (`org_doctor_id`) REFERENCES `org_doctor` (`id`)
);
